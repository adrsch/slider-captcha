...
const successIcon = (color) =>
  `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 3.44 2.728" height="10.312" width="13"><path d="M3.37.473L1.187 2.654.098 1.562l.409-.409.68.682L2.96.063z" fill="${color}"/></svg>`;

const failureIcon = (color) =>
  `<svg xmlns="http://www.w3.org/2000/svg" width="13" height="10.312" viewBox="0 0 3.44 2.728"><path d="M2.12 1.377l.961.962-.379.38-.964-.963-.962.963-.38-.38.963-.962L.396.413l.38-.38.962.963.964-.962.38.38z" fill="${color}"/></svg>`;
...
export { loadingIcon, failureIcon, successIcon, arrowIcon };
